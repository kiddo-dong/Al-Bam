...
주휴수당, 연장·야간·휴일 가산수당, 연소자 보호, 5인 미만 특례.
소규모 매장 사장님이 매달 부딪히지만 정확히 계산하기는 어려운 것들이다.

이 백엔드는 그 계산을 도맡고, **위반이 일어나기 전에 알린다.**

| | |
|---|---|
| **주 52시간·주휴 15시간 모니터링** | 넘기기 전에 주간 대시보드에서 보인다 |
| **5인 미만 자동 분기** | 가산수당 적용 여부가 매장 설정 하나로 갈린다 |
| **연소자 보호** | 생년월일로 주 40시간 상한·야간근로 제한이 자동 적용된다 |
| **알바생 예상 월급** | 확정 근태 + 남은 스케줄로 아직 안 끝난 달을 추정한다 |
| **AI 근로 상담** | 매장에 속하지 않아도 물어볼 수 있다 |
...
**테스트 151개.** 단위 테스트 외에 두 가지를 실제로 확인한다.
